...
export default function Header() {
  return (
    <header>
      ...
      sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full z-40"
        initial={{ y: -100, x: "-50%", opacity: 0 }}
        animate={{ y: 0, x: "-50%", opacity: 1 }}
      ></motion.div>
      <nav className="z-50 flex fixed  top-[0.15rem] -translate-x-1/2 left-1/2 h-12 py-2 sm:top-[1.7em] sm:h-[initial] sm:py-0">
